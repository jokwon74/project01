...
public class ExpiredPassJobConfig {
	...
	/*
	 * JpaCursorItemReader JpaPagingItemReader 만 지원! spring 4.3에서 추가된 페이징 기법보다 높은
	 * 성능으로 데이터 변경에 무관한 무결성 조회가 가능하다.
	 * 
	 * Map.of() java의 Map객체를 자동으로 생성하는 것!(객체)
	 */
	...
	public JpaCursorItemReader<PassEntity> expirePassItemReader() {
		...
		return new JpaCursorItemReaderBuilder<PassEntity>().name("expirePassItemReader") // ItemReader 여러개중 리더를 구분
